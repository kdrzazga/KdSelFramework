Feature: 5. Select Dropdown List
  ...
  Scenario Outline: 5.1 Choosing all weekdays in Select List Demo
  ...
  Scenario Outline: 5.2 Checking first selected item in Multi Select List
  ...
  Scenario Outline: 5.3 Checking all selected items in Multi Select List

    When I choose <States to Select> in Multi Select List
    And I click Get All Selected button on Multi Select List Demo div
    Then I expect message Options selected are :<Message with First Selected> displayed underneath
